...
KNOWN_PACKETS: dict[int, PacketDef] = {
    ...
    0x540c: PacketDef(
        ...
        description="Combat update — speed + entity position + movement state",
        fields=[
            FieldDef("entity_id", 2, 4, "u32le", "Entity ID"),
            ...
            FieldDef("state", 26, 4, "u32le", "Movement state (26=engage, 28=combat_move, 29/49/50=attack, 81=walk, 119=run)"),
            FieldDef("speed", 30, 4, "f32", "Movement speed (515=stance1, 644=stance2, varies by stance/class)"),
            FieldDef("combat_flags", 34, 4, "u32le", "Combat flags (0=idle, 1=in_combat)"),
        ],
        confirmed=True,
    ),
